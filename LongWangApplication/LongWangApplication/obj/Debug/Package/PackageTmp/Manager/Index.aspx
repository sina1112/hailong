    ...
    <div id="page" style="width: 1024px; height: 100%">
        <div id="north-panel">
            ...
            <tr>
                ...
                <td><input id="cityCombo" /></td>
                <td>酒店名：</td>
                <td><input type="text" id="hotelTxt" class="login_input" /></td>
                <td> <button id="searchBtn" class="btn-2letter">
                    搜索</button></td>
            </tr>
            </table>
        ...
        <div id="center-panel">
            <div style=" float:left; padding-top:5px; color:Red">上线酒店总数：<label id='lblacount'></label></div>
            <div style=" text-align:right;">
                
                 <button id="rstateSettingBtn" class="btn-moreletter">房态设置</button><button id="activeBtn" class="btn-moreletter">酒店上下线</button> 
            </div>
